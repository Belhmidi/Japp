...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: FrGYFq7yLRSO/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: KLsgusME3qGg/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__ssLgq)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___5WKl)}
              />
            </React.Fragment>
          ),
          value: args.children
