...
import sty from "./PlasmicNavBar.module.css"; // plasmic-import: SDaEQZxE2LvS/css
...
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: kZT43AvLh8c4/icon
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: mTVgT21mtU3l/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 7hXm7BscgLm-/icon
import ProfileIcon from "./icons/PlasmicIcon__Profile"; // plasmic-import: VAMjBaavLNfK/icon
import CartIcon from "./icons/PlasmicIcon__Cart"; // plasmic-import: mestqBXOK04x/icon
...
function PlasmicNavBar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__nKHzv, {
          [sty.freeBox__filled__nKHzvKp4Q]: hasVariant(
            variants,
            "filled",
            "filled"
          ),
          [sty.freeBox__searchOpen__nKHzv65IAm]: hasVariant(
            variants,
            "searchOpen",
            "searchOpen"
          )
      ...
      >
        <Button
          ...
          startIcon={
            <HomeIcon
              className={classNames(projectcss.all, sty.svg__dq13I)}
              role={"img"}
            />
          }
        >
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lRj6Q, {
            [sty.freeBox__searchOpen__lRj6Q65IAm]: hasVariant(
              variants,
              "searchOpen",
              "searchOpen"
            )
        ...
        >
          {(hasVariant(variants, "searchOpen", "searchOpen") ? false : true) ? (
            <Button
              ...
              startIcon={
                <SearchIcon
                  className={classNames(projectcss.all, sty.svg__a5Sjo)}
                  role={"img"}
                />
              }
            >
          ...
          <Button
            ...
            startIcon={
              <ProfileIcon
                className={classNames(projectcss.all, sty.svg__defvO)}
                role={"img"}
              />
            }
          >
          ...
          <div className={classNames(projectcss.all, sty.freeBox__rH2Sm)}>
            <Button
              ...
              startIcon={
                <CartIcon
                  className={classNames(projectcss.all, sty.svg__knlpy)}
                  role={"img"}
                />
              }
            >
