...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: ePmbb3cTsIpf/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: KLsgusME3qGg/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: qVkjDhytUlef/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: NWCZxXSBzmfB/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__cQOZ)}
    ...
    props = {
      ...
      children: (
        <React.Fragment>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__ikHjF)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
