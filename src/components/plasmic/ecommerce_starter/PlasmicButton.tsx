...
import sty from "./PlasmicButton.module.css"; // plasmic-import: RwhbLl_Om_ZC/css
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___5MYrJ, {
            [sty.freeBox__iconOnly___5MYrJIjiKm]: hasVariant(
              variants,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBox__showEndIcon___5MYrJoVdL4]: hasVariant(
              variants,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBox__showStartIcon___5MYrJVlpjS]: hasVariant(
              variants,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBox__size_large___5MYrJkbam6]: hasVariant(
              variants,
              "size",
              "large"
            ),
            [sty.freeBox__size_small___5MYrJ0GOgx]: hasVariant(
              variants,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg___5J8Yq)}
                    role={"img"}
                  />
                ),
      ...
      {(hasVariant(variants, "iconOnly", "iconOnly") ? true : true)
        ? p.renderPlasmicSlot({
            ...
            className: classNames(sty.slotTargetChildren, {
              ...
              [sty.slotTargetChildren__rounded]: hasVariant(
                variants,
                "rounded",
                "rounded"
              ),
              ...
              [sty.slotTargetChildren__size_large_rounded]:
                hasVariant(variants, "size", "large") &&
                hasVariant(variants, "rounded", "rounded"),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__oodK, {
            [sty.freeBox__showEndIcon__oodKoVdL4]: hasVariant(
              variants,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBox__size_small__oodK0GOgx]: hasVariant(
              variants,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__jZwcd)}
                    role={"img"}
                  />
                ),
