...
import sty from "./PlasmicValue.module.css"; // plasmic-import: 7pr-oMTovPPk/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: HJRyLFWnPo_3/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__yySo6, {
          [sty.freeBox__center__yySo6DKaR3]: hasVariant(
            variants,
            "center",
            "center"
          ),
          [sty.freeBox__topBottom__yySo6Vzjsq]: hasVariant(
            variants,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__jT2Ye)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__eb0F)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jnRiu, {
          [sty.freeBox__center__jnRiuDKaR3]: hasVariant(
            variants,
            "center",
            "center"
          ),
          [sty.freeBox__withButton__jnRiuzDzl]: hasVariant(
            variants,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant(variants, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___9R8Ui, {
            [sty.freeBox__center___9R8UidKaR3]: hasVariant(
              variants,
              "center",
              "center"
            ),
            [sty.freeBox__withButton___9R8UIzDzl]: hasVariant(
              variants,
              "withButton",
              "withButton"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__i8Tv2, {
                  [sty.button__withButton__i8Tv2ZDzl]: hasVariant(
                    variants,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__nV1Zs)}
                    role={"img"}
                  />
                }
